...
public class QuizUserDataService {
    ...
    public QuizUserDataService(QuizUserDataRepository quizUserDataRepository, QuizRepository quizRepository) {
...
//            throw new IllegalArgumentException("이미 조회 데이터가 생성되었습니다.");
        } else {
